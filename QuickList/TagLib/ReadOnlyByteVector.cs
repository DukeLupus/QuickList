namespace Sander.QuickList.TagLib
{
	...
	public sealed class ReadOnlyByteVector : ByteVector
	{
		...
		///         use <see cref="ReadOnlyByteVector(int,byte)" />.
		///     </para>
		/// </remarks>
		...
		///         <see cref="ReadOnlyByteVector(byte[])" />.
		///     </para>
		/// </remarks>
		...
		///         <see
		///             cref="ReadOnlyByteVector(byte[],int)" />
		///         .
		///     </para>
		/// </remarks>
