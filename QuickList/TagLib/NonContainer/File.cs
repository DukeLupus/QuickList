...
namespace Sander.QuickList.TagLib.NonContainer
{
	/// <summary>
	...
	/// <remarks>
	///     <para>
	///         When extending this class, <see cref="ReadStart" />,
	///         <see
	///             cref="ReadEnd" />
	///         , and <see cref="ReadProperties" /> should be
	...
	///     <list type="number">
	///         <item>
	///             <term>The file is opened for reading.</term>
	///         </item>
	///         <item>
	///             <term>
	...
	///         </item>
	///         <item>
	///             <term><see cref="ReadStart" /> is called.</term>
	///         </item>
	///         <item>
	///             <term>
	...
	///         </item>
	///         <item>
	///             <term><see cref="ReadEnd" /> is called.</term>
	///         </item>
	///         <item>
	///             <term>
	///                 If reading with a style other than
	///                 <see
	///                     cref="ReadStyle.None" />
	///                 , <see cref="ReadProperties" /> is
	///                 called.
	///             </term>
	///         </item>
	///         <item>
	///             <term>The file is closed.</term>
	///         </item>
	///     </list>
	/// </remarks>
	public abstract class File : TagLib.File
	{
		...
		///     with a read style other than <see cref="ReadStyle.None" />, and as such MUST NOT return <see langword="null" />.
		///     It is guaranteed that <see cref="ReadStart" /> and
		///     <see
		///         cref="ReadEnd" />
		///     will have been called first and this
