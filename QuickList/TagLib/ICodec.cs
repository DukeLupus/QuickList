...
{
	/// <summary>
	///     Indicates the types of media represented by a <see cref="ICodec" /> or <see cref="Properties" /> object.
	/// </summary>
	/// <remarks>
	...
	/// <remarks>
	///     <para>
	///         When dealing with a <see cref="ICodec" />, if
	///         <see
	///             cref="ICodec.MediaTypes" />
	///         contains <see cref="MediaTypes.Audio" />, it is safe to assume that the object also inherits
	///         <see
	///             cref="IAudioCodec" />
	...
	///         <see
	///             cref="ICodec.MediaTypes" />
	///         contains <see cref="MediaTypes.Video" />, it is safe to assume that the object also inherits
	///         <see
	///             cref="IVideoCodec" />
	///         and can be recast without issue.
	///     </para>
