...
namespace Sander.QuickList.TagLib
{
	...
	public class ListBase<T> : IList<T> where T : IComparable<T>
	{
		...
		///    cref="T:Sander.QuickList.TagLib.ListBase`1" /> with no contents.
		/// </summary>
		public ListBase()
		{
		}
		...
		/// <summary>
		///    Constructs and initializes a new instance of <see
		///    cref="T:Sander.QuickList.TagLib.ListBase`1" /> with specified contents.
		/// </summary>
		/// <param name="list">
		...
		/// </summary>
		/// <param name="list">
		///    A <see cref="T:Sander.QuickList.TagLib.ListBase`1"/> object containing
