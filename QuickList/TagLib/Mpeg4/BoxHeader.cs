...
namespace Sander.QuickList.TagLib.Mpeg4
{
	/// <summary>
	...
	public struct BoxHeader
	{
		...
		///     <see
		///         cref="BoxHeader" />
		///     by reading it from a specified seek
		...
		///     <paramref name="extendedType" /> isn't
		///     <see
		///         langword="null" />
		///     - or - paramref name="type" /> is
		...
		///     extended type, or <see langword="null" /> if
		///     <see
		///         cref="BoxType" />
		///     is not "<c>uuid</c>".
		/// </value>
		...
		public long Overwrite(TagLib.File file, long sizeChange)
		{
			...
			var old_header_size = HeaderSize;
			DataSize += sizeChange;
		...
		public ByteVector Render()
		{
			...
			var output = ByteVector.FromUInt(
				header_size == 8 || header_size == 24 ? (uint)box_size : 1);
