...
namespace Sander.QuickList.TagLib.Flac
{
	/// <summary>
	...
	public sealed class Block
	{
		...
		///     <see
		///         cref="Block" />
		///     with a specified header and internal
		///     data.
		/// </summary>
		/// <param name="header">
		...
		///     <see
		///         cref="Block" />
		///     with of a specified type and internal
		///     data.
		/// </summary>
		/// <param name="type">
		...
		///     and is followed immediately by the audio data, or
		///     <see
		///         langword="false" />
		///     if another block appears after the
