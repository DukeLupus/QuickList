...
using Sander.QuickList.TagLib.Ogg.Codecs;
...
namespace Sander.QuickList.TagLib.Ogg
{
	...
	public abstract class Codec : ICodec
	{
		...
		///         codec detection system by creating a
		///         <see
		///             cref="CodecProvider" />
		///         and registering it with
		///         <see
		///             cref="AddCodecProvider" />
		///         .
		///     </para>
		///     <para>
		///         A method implementing <see cref="CodecProvider" />
		...
		///     support for new <see cref="Codec" /> subclasses in
		///     <see
		///         cref="GetCodec" />
		///     .
		/// </remarks>
