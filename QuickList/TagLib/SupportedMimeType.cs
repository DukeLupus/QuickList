...
namespace Sander.QuickList.TagLib
{
	...
	public sealed class SupportedMimeType : Attribute
	{
		...
		///     registered by the current instance, or
		///     <see
		///         langword="null" />
		///     if not specified.
		/// </value>
		...
		///         <see
		///             cref="TagLib.File.Create(string,string,ReadStyle)" />
		///         to
		///         match file types.
		///     </para>
		/// </remarks>
