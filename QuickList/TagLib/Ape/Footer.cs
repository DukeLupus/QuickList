...
namespace Sander.QuickList.TagLib.Ape
{
	/// <summary>
	...
	public struct Footer : IEquatable<Footer>
	{
		...
		///     <see
		///         cref="Footer" />
		///     by reading it from raw footer data.
		/// </summary>
		/// <param name="data">
		...
		///     <paramref name="data" /> is smaller than
		///     <see
		///         cref="Size" />
		...
		/// <summary>
		///     Gets whether or not two instances of <see cref="Footer" /> are equal to eachother.
		/// </summary>
		/// <param name="first">
		...
		/// <summary>
		///     Gets whether or not two instances of <see cref="Footer" /> are unequal to eachother.
		/// </summary>
		/// <param name="first">
		///     The first <see cref="Footer" /> object to compare.
		/// </param>
